...
class Config {
    ...
    public static function enqueue_assets() {
        ...
        wp_enqueue_style( 'fonts', 'http://fonts.googleapis.com/css?family=Lato:300,400,700,400italic,700italic|Lilita+One|Swanky+and+Moo+Moo' );
        wp_enqueue_style( 'app', NV_CSS.'/app.css' );
        wp_enqueue_style( 'iaj_master', NV_CSS.'/iaj_master.css' );
